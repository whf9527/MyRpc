...
static void InitDefaultsscc_info_RpcHeader_myrpcHeader_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RpcHeader_myrpcHeader_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_RpcHeader_myrpcHeader_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_myrpcHeader_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_myrpcHeader_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_myrpcHeader_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_myrpcHeader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_myrpcHeader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021myrpcHeader.proto\022\005myrpc\"I\n\tRpcHeader\022"
  "\024\n\014service_name\030\001 \001(\014\022\023\n\013method_name\030\002 \001"
  "(\014\022\021\n\targs_size\030\003 \001(\rb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_myrpcHeader_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_myrpcHeader_2eproto_sccs[1] = {
  &scc_info_RpcHeader_myrpcHeader_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_myrpcHeader_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_myrpcHeader_2eproto = {
  false, false, descriptor_table_protodef_myrpcHeader_2eproto, "myrpcHeader.proto", 109,
  &descriptor_table_myrpcHeader_2eproto_once, descriptor_table_myrpcHeader_2eproto_sccs, descriptor_table_myrpcHeader_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_myrpcHeader_2eproto::offsets,
  file_level_metadata_myrpcHeader_2eproto, 1, file_level_enum_descriptors_myrpcHeader_2eproto, file_level_service_descriptors_myrpcHeader_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_myrpcHeader_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_myrpcHeader_2eproto)), true);
namespace myrpc {
...
void RpcHeader::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RpcHeader_myrpcHeader_2eproto.base);
  service_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  method_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  args_size_ = 0u;
}
